...
>Basic installation instructions for prism_uipack</div>
...
- **Drag-and-drop our script** : Drag `prism_uipack` in to your `resources` directory and add `ensure prism_uipack` to your `server.cfg`
- **Restart your server**.