...
Config.Interaction = 'drawtext' --  or 'target' or 'textui' or 'drawtext'
...
Config.CardSettings = {
    ['business'] = {
       ...
       creditScoreRequired = 350 -- Credit score required to open a business account
    },
    ['express'] = {
       InterestRate = 1.7, -- 1.7% interest rate
       creditScoreRequired = 700 -- Credit score required to open an express account
    }
}
