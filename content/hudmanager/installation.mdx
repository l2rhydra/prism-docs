...
>Basic installation instructions for prism_hudmanager</div>

<Callout type="error">
  **WARNING** : Resource must be named ``prism_hudmanager`` to operate properly.
</Callout>
...
- **Drag-and-drop our script** : Drag `prism_hudmanager` in to your `resources` directory and add `ensure prism_hudmanager` to your `server.cfg`
- **Restart your server**.