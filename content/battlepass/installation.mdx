...
>Basic installation instructions for prism_battlepass</div>
...
- **Drag-and-drop our script** : Drag prism_battlepass in to your `resources` directory and add ensure `prism_battlepass` to your `server.cfg` after all dependencies.
- **Restart your server**.